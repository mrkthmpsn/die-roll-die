...
def create_die(
    ...
    Raises:
        ValueError: if `denominator` is negative or, where the model counts it, fractional;
            or if the entity's observations disagree with `prior` about the entity type.
    """
